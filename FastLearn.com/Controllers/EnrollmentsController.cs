...
namespace FastLearn.com.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,StudentID,CourseID,price")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,StudentID,CourseID,price")] Enrollment enrollment)
        {
            if (ModelState.IsValid)
            {
